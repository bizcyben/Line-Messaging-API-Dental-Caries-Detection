...
const app = express();
const config = {
  channelAccessToken: 'add ur channelAccessToken',
  channelSecret: 'add ur channelSecret'
};
...
async function handleEvent(event) {
    ...
    try {
      ...
      const imageUrl = `https://f0e5-61-7-228-206.ngrok-free.app/images/${path.basename(detectedImagePath)}`;
      messages.push({
        type: 'image',
